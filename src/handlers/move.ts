...
export function handleCmovIzImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleCmovNzImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleSetLtUImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleSetLtSImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleSetGtUImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleSetGtSImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
