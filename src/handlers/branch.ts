...
export function handleBranchEq(
...
export function handleBranchNe(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchLtU(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchLtS(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchGeU(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchGeS(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
function decode1r1i1o(
	...
	const target =
		pc + readSignedImm(code, pc + 2 + immediateLength, offsetLength);
	return [ra, dist, imm, target, dist];
}

export function handleBranchEqImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchNeImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchLtUImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchLeUImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchGeUImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchGtUImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchLtSImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchLeSImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchGeSImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleBranchGtSImm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleLoadImmJump(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
 ...
 */
export function handleLoadImmJumpInd(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
