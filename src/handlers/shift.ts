...
export function handleShloLImm32(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleShloRImm32(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleSharRImm32(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleShloLImm64(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleShloRImm64(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleSharRImm64(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleShloLImmAlt32(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleShloRImmAlt32(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleSharRImmAlt32(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleShloLImmAlt64(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleShloRImmAlt64(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleSharRImmAlt64(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleRotR64Imm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
	...
	ctx.regs.setU64(
		ra,
		rotateRight64(ctx.regs.getU64(rb), BigInt(imm) & 0xffffffffn),
	);
	return pc + dist;
}

export function handleRotR64ImmAlt(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
	...
	ctx.regs.setU64(
		ra,
		rotateRight64(BigInt.asUintN(64, BigInt(imm)), ctx.regs.getU64(rb)),
	);
	return pc + dist;
}

export function handleRotR32Imm(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleRotR32ImmAlt(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
