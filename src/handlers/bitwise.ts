...
export function handleAndInv(
	...
	ctx.regs.setU64(
		rd,
		BigInt.asUintN(64, ctx.regs.getU64(ra) & ~ctx.regs.getU64(rb)),
	);
	return pc + 1 + skip[pc + 1];
}

export function handleOrInv(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleCountSetBits64(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleCountSetBits32(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleSignExtend8(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleSignExtend16(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleZeroExtend16(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
...
export function handleReverseBytes(
	ctx: InterpreterContext,
	pc: number,
	code: Uint8Array,
	skip: Uint8Array,
