 ...
 */
export function readUnsignedImm32(
	code: Uint8Array,
	offset: number,
	length: number,
): number {
 ...
 */
export function readSignedImmBigInt(
	code: Uint8Array,
	offset: number,
	length: number,
): bigint {
...
export function mulUpperUU(a: bigint, b: bigint): bigint {
	return BigInt.asUintN(
		64,
		(BigInt.asUintN(64, a) * BigInt.asUintN(64, b)) >> 64n,
	);
}
...
export function mulUpperSU(a: bigint, b: bigint): bigint {
	return BigInt.asUintN(
		64,
		(BigInt.asIntN(64, a) * BigInt.asUintN(64, b)) >> 64n,
	);
}
